# -*- coding: utf-8 -*-
"""english-to-hindi-translator.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1TBjsOc4L9-XlTtHkoVEpVMV3p6AuJ4kB
"""
...
lines=lines.sample(n=len(lines), random_state=101) # Sample all the rows
lines.shape
...
stop_words = stopwords.words('english') # Define stop_words here
...
checkpoint_path = "/kaggle/working/training_1/cp.ckpt.weights.h5" # Added '.weights.h5' to the filepath
